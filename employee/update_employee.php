    ...
    <div class="azaira"></div>
            ...
            <div class="l_container">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] . '?id=' . $id; ?>" method="post">
                    ...
                    <div class="form-floating mb-3">
                        <textarea value="<?php echo $row['qualification']; ?>" name="e_qualification" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea>
                    ...
                    <div class="form-floating">
                            <a href="all_employee.php" ><input name="update" type="submit" class="btn btn-dark mb-4"></a>
                    </div>
