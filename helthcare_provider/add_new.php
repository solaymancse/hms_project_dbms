...
<?php
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO healthcare_provider(first_name, last_name,
                        qualification, phone_number, dep_id , address, gender, TYPE, DOB, email) VALUES
                        ('$f_name', '$l_name', '$qual', '$p_num' , '$dep_id' , '$address', '$gender', '$type', '$dob', '$email')";
            ...
            if ($result) {
                ...
                echo "<script>window.location.href='healthcare_provider.php' </script>";
                    ...
                    <div class="box">
                        ...
                        <select name="dep_type" id="">
                            ...
                            ?>
                                ...
                                <option value="<?php echo $row1['dep_id']?>"><?php echo $row1['department_name']?></option>
